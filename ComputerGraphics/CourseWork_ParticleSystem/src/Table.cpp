...
#include "table.h"
//////////////////////////////////////////////////////////////////////////
Table::Table(LPDIRECT3DDEVICE9 const pDevice) : Mesh3DObject(pDevice)
{
	Load("assets\\table.x", ".\\assets\\",true);
	ChangePos(D3DXVECTOR3(0,25.0,70)); 
	SetScale (D3DXVECTOR3(8,8,8));
}
//////////////////////////////////////////////////////////////////////////
Table::~Table(void)
{
